...
const translations = {
  es: {
    ...
    notif_assigned: 'Cuando te apuntan a un partido',
    notif_kicked: 'Cuando te expulsan de un partido',
    notif_reminders: 'Recordatorios automáticos',
    notif_changes: 'Cambios de fecha / horario',
    notif_cancellations: 'Cancelaciones',
    notif_templates_title: 'Textos de notificaciones',
    notif_title_label: 'Título',
    notif_body_label: 'Cuerpo',
    notif_templates_help: 'Puedes usar texto libre o variables para mantener los detalles dinámicos.',
    notif_templates_tokens: 'Variables disponibles: {defaultTitle}, {description}, {actorName}, {targetName}, {matchDate}, {matchTime}, {location}, {appName}, {reason}, {minutesBefore}',
    notif_templates_saved: 'Los textos de las notificaciones se han actualizado.',
    notif_auto_reminders_title: 'Avisos automáticos',
    notif_auto_reminders_desc: 'Se enviarán solo a los jugadores apuntados que tengan activados los recordatorios.',
    notif_auto_reminders_empty: 'No hay avisos automáticos configurados.',
    notif_auto_reminders_add: 'Añadir aviso',
    notif_auto_reminders_saved: 'Los avisos automáticos se han actualizado.',
    notif_auto_reminders_minutes: 'Minutos antes del partido',
    ...
    delete_group_confirm: 'Eliminar Grupo?', delete_group_msg: 'Se eliminara el grupo permanentemente.',
    tournament: 'Torneo', coming_soon: 'En breves...',
    coming_soon_desc: 'El próximo torneo de Padel Sabardes se anunciara próximamente. Mantente atento!',
    ...
    rule_1_text: 'Cada jugador busca y solicita partner. El otro debe aceptar la invitacion. Una vez formada la pareja, no se puede cambiar de fase sin aprobacion del admin.',
    rule_2_title: 'Fase 2 — Clasificación (Round Robin)',
    rule_2_text: 'La app genera automaticamente el calendario: todas las parejas juegan contra todas. Cada semana hay un enfrentamiento obligatorio. La pareja solicita el dia y hora; los admins aprueban la reserva de pista (o lo hacen automaticamente si esta activado en Ajustes). El rival debe confirmar el resultado para que sea oficial.',
    rule_3_title: 'Fase 3 — Cuadro Final',
    rule_3_text: 'Las 8 mejores parejas de la clasificacion pasan a las eliminatorias: Cuartos de Final → Semifinal → Final. Si hay empate en puntos, se juega un partido de desempate antes de avanzar.',
    rule_4_title: 'Resultados',
    rule_4_text: 'El equipo ganador sube el marcador (ej. 6-2, 4-6, 7-5). El equipo perdedor debe confirmar el resultado. Hasta que ambas partes esten de acuerdo, el resultado queda como pendiente de validacion.',
    rule_5_title: 'Sistema de Puntos',
    rule_5_text: 'Victoria: 1 punto | Derrota: 0 puntos. En caso de empate en puntos, se usara el average de sets ganados/perdidos como desempate.',
    manage_tournament_slots: 'Gestionar Horarios Torneo',
    add_slot: 'Añadir Franja',
    day_l: 'Lunes', day_m: 'Martes', day_x: 'Miercoles', day_j: 'Jueves', day_v: 'Viernes', day_s: 'Sabado', day_d: 'Domingo',
    ...
    action_view_match: 'Ver partido',
    action_manage_match: 'Gestionar',
    action_pick_slot: 'Elegir hueco',
    availability_free: 'Libre',
    availability_busy: 'Ocupada',
    availability_near: 'Cerca',
    availability_legend: 'Disponibilidad de pista',
    match_history_title: 'Historial del partido',
    match_history_empty: 'Todavía no hay cambios registrados.',
    match_history_created: '{actorName} creó el partido.',
    match_history_updated: '{actorName} actualizó el partido.',
    match_history_schedule_changed: '{actorName} cambió el horario al {matchDate} a las {matchTime}.',
    match_history_joined: '{actorName} se apuntó al partido.',
    match_history_left: '{actorName} salió del partido.',
    match_history_added: '{actorName} añadió a {targetName}.',
    match_history_kicked: '{actorName} expulsó a {targetName}.',
    cancel_reason_label: 'Motivo de cancelación',
    cancel_reason_optional: 'Opcional',
    cancel_reason_placeholder: 'Añade un motivo si quieres incluirlo en la notificación.',
  ...
  gl: {
    ...
    your_matches: 'Os Teus Partidos', no_matches: 'Non tes partidos programados nin invitacions.',
    confirmed_participants: 'Participantes Confirmados', no_participants: 'Ainda non hai inscritos',
    free_spots: 'Prazas Libres', joined: 'Apuntado',
    match_full: 'O partido xa esta completo', party_status_open: 'aberto',
    create_match: 'Crear Partido', save_changes: 'Gardar Cambios',
    date: 'DATA', time: 'HORA', players: 'Xogadores',
    invitations: 'Invitacions', everyone_global: 'Todos (Global)',
    ...
    language: 'Idioma',
    admin_options: 'Admin — Torneos', auto_approve: 'Aprobación Automática',
    auto_approve_desc: 'Acepta solicitudes de pista de torneo sen revision manual',
    ...
    notif_retry_perms: 'Reintentar Permisos',
    notif_invitations: 'Invitacions a partidos',
    notif_joins: 'Cando alguen se apunta',
    notif_leaves: 'Cando alguen se desapunta',
    notif_assigned: 'Cando te apuntan a un partido',
    notif_kicked: 'Cando te expulsan dun partido',
    notif_reminders: 'Recordatorios automáticos',
    notif_changes: 'Cambios de data / horario',
    notif_cancellations: 'Cancelacions',
    notif_templates_title: 'Textos das notificacións',
    notif_title_label: 'Título',
    notif_body_label: 'Corpo',
    notif_templates_help: 'Podes usar texto libre ou variables para manter os detalles dinámicos.',
    notif_templates_tokens: 'Variables dispoñibles: {defaultTitle}, {description}, {actorName}, {targetName}, {matchDate}, {matchTime}, {location}, {appName}, {reason}, {minutesBefore}',
    notif_templates_saved: 'Os textos das notificacións actualizáronse.',
    notif_auto_reminders_title: 'Avisos automáticos',
    notif_auto_reminders_desc: 'Enviaranse só aos xogadores apuntados que teñan activados os recordatorios.',
    notif_auto_reminders_empty: 'Non hai avisos automáticos configurados.',
    notif_auto_reminders_add: 'Engadir aviso',
    notif_auto_reminders_saved: 'Os avisos automáticos actualizáronse.',
    notif_auto_reminders_minutes: 'Minutos antes do partido',
    ...
    tournament: 'Torneo', coming_soon: 'En breves...',
    coming_soon_desc: 'O próximo torneo do Padel Sabardes anunciase próximamente. Mantente atento!',
    ...
    find_partner: 'Buscar Parella', my_pair: 'A Mina Parella',
    invite_pending: 'Pendente de aceptación...', pair_confirmed: 'Confirmada ✓',
    accept: 'Aceptar', decline: 'Rexeitar', choose_partner: 'Escoller Companeiro',
    start_phase1: 'Iniciar Fase 1', advance_phase2: 'Avanzar a Fase 2',
    advance_phase3: 'Avanzar a Fase 3', reset_tournament: 'Resetear Torneo',
    tournament_control: 'Panel de Control — Admin',
    standings: 'Taboa de Clasificación', my_matches: 'Os Meus Partidos',
    ...
    rule_1_text: 'Cada xogador busca e solicita partner. O outro debe aceptar a invitacion. Unha vez formada a parella, non se pode cambiar de fase sen aprobacion do admin.',
    rule_2_title: 'Fase 2 — Clasificación (Round Robin)',
    rule_2_text: 'A app xera automaticamente o calendario: todas as parellas xogan contra todas. Cada semana hai un enfrontamento obrigatorio. A parella solicita o dia e hora; os admins aproban a reserva de pista (ou o fan automaticamente se esta activado en Axustes). O rival debe confirmar o resultado para que sexa oficial.',
    rule_3_title: 'Fase 3 — Cadro Final',
    rule_3_text: 'As 8 mellores parellas da clasificacion pasan as eliminatorias: Cuartos de Final → Semifinal → Final. Se hai empate en puntos, xogase un partido de desempate antes de avanzar.',
    rule_4_title: 'Resultados',
    rule_4_text: 'O equipo ganador sobe o marcador (ex. 6-2, 4-6, 7-5). O equipo perdedor debe confirmar o resultado. Ata que ambas partes estean de acordo, o resultado queda como pendente de validacion.',
    rule_5_title: 'Sistema de Puntos',
    rule_5_text: 'Vitoria: 1 punto | Derrota: 0 puntos. En caso de empate en puntos, usarase o average de sets ganados/perdidos como desempate.',
    manage_tournament_slots: 'Xestionar Horarios Torneo',
    add_slot: 'Engadir Franxa',
    day_l: 'Luns', day_m: 'Martes', day_x: 'Mercores', day_j: 'Xoves', day_v: 'Venres', day_s: 'Sabado', day_d: 'Domingo',
    propose_slots: 'Proponer Horarios',
    ...
    delete_all: 'Borrar Todo',
    action_view_match: 'Ver partido',
    action_manage_match: 'Xestionar',
    action_pick_slot: 'Escoller oco',
    availability_free: 'Libre',
    availability_busy: 'Ocupada',
    availability_near: 'Cerca',
    availability_legend: 'Dispoñibilidade da pista',
    match_history_title: 'Historial do partido',
    match_history_empty: 'Aínda non hai cambios rexistrados.',
    match_history_created: '{actorName} creou o partido.',
    match_history_updated: '{actorName} actualizou o partido.',
    match_history_schedule_changed: '{actorName} cambiou o horario ao {matchDate} ás {matchTime}.',
    match_history_joined: '{actorName} apuntouse ao partido.',
    match_history_left: '{actorName} saíu do partido.',
    match_history_added: '{actorName} engadiu a {targetName}.',
    match_history_kicked: '{actorName} expulsou a {targetName}.',
    cancel_reason_label: 'Motivo da cancelación',
    cancel_reason_optional: 'Opcional',
    cancel_reason_placeholder: 'Engade un motivo se queres incluílo na notificación.',
...
export const LanguageProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const value = useMemo(() => ({
    language,
    setLanguage,
    t: (key: TranslationKey) => translations[language][key] || translations.es[key] || key,
  }), [language]);
